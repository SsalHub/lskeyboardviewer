...
1. 반드시 **관리자 권한**으로 실행해야 게임 화면 위에서 안정적으로 동작합니다.
2. 백그라운드에서 키 입력을 받는 키뷰어 프로그램 구조상, 보안 위협 프로그램으로 감지될 가능성이 있습니다.
     * 본 프로그램은 절대로 키뷰어 기능 외의 목적으로 키보드 입력 및 계정 정보를 수집하거나 활용하지 않습니다.
3. 이 프로그램에 사용된 아이콘의 저작권은 (주)밸로프/위메이드에 있습니다.
---
